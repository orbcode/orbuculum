...
* Link Monitoring and reporting is now available, enabled with the `-m` option.
* Simple colour support is now included (disable by commenting out `SCREEN_HANDLING` in the makefile).
